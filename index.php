...
<head>
    <title>Milky Baby - Home Page</title>
    <meta charset="utf-8" />
        ...
        <div class="container text-light">
            <div class="w-100 d-flex justify-content-between">
              ...
              ?>!
                ...
                <div>
                    <a href="login.php" class="logout-btn text-decoration-none text-light">Log
                        Out</a>
                </div>
            </div>
        </div>
                    ...
                    <div class="row p-5">
                        ...
                        <div class="col-lg-6 mb-0 d-flex align-items-center">
                            <div class="text-align-left align-self-center">
                                <h1 class="h1 text-success"><b>Milky Baby</b></h1>
                                <h3 class="h2">The first baby milk store in Purwakarta</h3>
                                <p>
                                    Welcome to our store, the best destination for parents who care about their child's
                                    health and development! Our store is dedicated to providing a selection of
                                    nutrient-rich milk and related products to meet your baby's needs.
                                </p>
                            </div>
                        </div>
                    </div>
